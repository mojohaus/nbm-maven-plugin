 ...
 * @aggregator
 */
public class CreateWebstartMojo
        extends AbstractDistributionMojo
{
    ...
    public void execute() throws MojoExecutionException, MojoFailureException
    {
        try
        {
            File webstartBuildDir = new File(
                    projectBuildDir + File.separator + "webstart" + File.separator + brandingToken );
            ...
            File platformClusterDirectory = findPlatformClusterDirectory(
                    enabledClusterDirectories );
            ...
            {
                getLog().error(
                        "Cannot find cluster directories for all enabled clusters:" );
                getLog().error( "enabled clusters: " + enabledClusters );
                getLog().error(
                        "found directories: " + enabledClusterDirectories );
    ...
    private String copyLauncher( File standaloneBuildDir ) throws IOException
    {
        ...
        if ( !jnlpStarter.exists() )
        {
            throw new IOException(
                    "jnlp-launcher.jar not found at " + jnlpStarter );
        }
